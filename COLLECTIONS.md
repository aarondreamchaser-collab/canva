...
Estado general de la producción. Actualizar cada vez que se cree, avance o
termine un diseño.
...
- **Diseños (20):**
  ...
  5. Trail Frog Ranger — rana — `concepto`
  6. Gas Station Tom — gato — `concepto`
  7. County Fair Champion Cow — vaca — `concepto`
  8. Night Fisherman Bear — oso — `concepto`
  9. Howler Spirit Badge — perro — `concepto`
  10. Don't Feed the Duck — pato — `concepto`
  11. Route Dog Trucking Co. — perro — `concepto`
  12. Trash Panda Fishing Club — mapache — `concepto`
  13. Frog & Moth Night Diner — rana — `concepto`
  14. Roadside Frog Motel — rana — `concepto`
  15. Duck Patrol Lifeguard — pato — `concepto`
  16. Alley Boxing Club — gato — `concepto`
  17. Search & Rescue Mutt — perro — `concepto`
...
Cuando un diseño avance a producción (Fase 4 en adelante), se le crea su
carpeta `NN-nombre-diseno/` dentro de la colección y se actualiza su estado
aquí.
